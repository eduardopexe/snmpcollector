...
XS(XS_Digest__SHA1_new); /* prototype to pass -Wmissing-prototypes */
XS(XS_Digest__SHA1_new)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: Digest::SHA1::new(xclass)");
    SP -= items;
    {
	SV*	xclass = ST(0);
#line 466 "SHA1.xs"
...
XS(XS_Digest__SHA1_clone); /* prototype to pass -Wmissing-prototypes */
XS(XS_Digest__SHA1_clone)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: Digest::SHA1::clone(self)");
    SP -= items;
    {
	SV*	self = ST(0);
#line 485 "SHA1.xs"
...
XS(XS_Digest__SHA1_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_Digest__SHA1_DESTROY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: Digest::SHA1::DESTROY(context)");
    {
...
XS(XS_Digest__SHA1_add); /* prototype to pass -Wmissing-prototypes */
XS(XS_Digest__SHA1_add)
{
    dXSARGS;
    if (items < 1)
	Perl_croak(aTHX_ "Usage: Digest::SHA1::add(self, ...)");
    SP -= items;
    {
	SV*	self = ST(0);
#line 506 "SHA1.xs"
...
XS(XS_Digest__SHA1_addfile); /* prototype to pass -Wmissing-prototypes */
XS(XS_Digest__SHA1_addfile)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: Digest::SHA1::addfile(self, fh)");
    {
	SV*	self = ST(0);
...
XS(XS_Digest__SHA1_digest); /* prototype to pass -Wmissing-prototypes */
XS(XS_Digest__SHA1_digest)
{
    dXSARGS;
    dXSI32;
    if (items != 1)
...
XS(XS_Digest__SHA1_sha1); /* prototype to pass -Wmissing-prototypes */
XS(XS_Digest__SHA1_sha1)
{
    dXSARGS;
    dXSI32;
...
XS(XS_Digest__SHA1_sha1_transform); /* prototype to pass -Wmissing-prototypes */
XS(XS_Digest__SHA1_sha1_transform)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: Digest::SHA1::sha1_transform(data)");
    SP -= items;
    {
	SV*	data = ST(0);
#line 607 "SHA1.xs"
...
extern "C"
#endif
XS(boot_Digest__SHA1); /* prototype to pass -Wmissing-prototypes */
XS(boot_Digest__SHA1)
{
    dXSARGS;
    char* file = __FILE__;

 ...
 * contents of SNMP.xs. Do not edit this file, edit SNMP.xs instead.
 *
...
XS(XS_SNMP_constant); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP_constant)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: SNMP::constant(name, arg)");
    {
...
XS(XS_SNMP__sys_uptime); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__sys_uptime)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: SNMP::_sys_uptime()");
    {
	long	RETVAL;
	dXSTARG;
#line 2649 "SNMP.xs"
...
XS(XS_SNMP_init_snmp); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP_init_snmp)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::init_snmp(appname)");
    {
	char *	appname = (char *)SvPV_nolen(ST(0));
#line 2657 "SNMP.xs"
...
XS(XS_SNMP__api_mode); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__api_mode)
{
    dXSARGS;
    if (items < 0 || items > 1)
	Perl_croak(aTHX_ "Usage: SNMP::_api_mode(mode=(int)NULL)");
    {
	int	mode;
	int	RETVAL;
	dXSTARG;
...
XS(XS_SNMP__new_session); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__new_session)
{
    dXSARGS;
    if (items != 6)
	Perl_croak(aTHX_ "Usage: SNMP::_new_session(version, community, peer, lport, retries, timeout)");
    {
	char *	version = (char *)SvPV_nolen(ST(0));
	char *	community = (char *)SvPV_nolen(ST(1));
	char *	peer = (char *)SvPV_nolen(ST(2));
	int	lport = (int)SvIV(ST(3));
	int	retries = (int)SvIV(ST(4));
	int	timeout = (int)SvIV(ST(5));
	SnmpSession *	RETVAL;
#line 2676 "SNMP.xs"
	{
...
#line 2791 "SNMP.c"
	ST(0) = sv_newmortal();
	sv_setref_pv(ST(0), "SnmpSessionPtr", (void*)RETVAL);
    }
    XSRETURN(1);
}


XS(XS_SNMP__new_v3_session); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__new_v3_session)
{
    dXSARGS;
    if (items != 23)
	Perl_croak(aTHX_ "Usage: SNMP::_new_v3_session(version, peer, retries, timeout, sec_name, sec_level, sec_eng_id, context_eng_id, context, auth_proto, auth_pass, priv_proto, priv_pass, eng_boots, eng_time, auth_master_key, auth_master_key_len, priv_master_key, priv_master_key_len, auth_localized_key, auth_localized_key_len, priv_localized_key, priv_localized_key_len)");
    {
	int	version = (int)SvIV(ST(0));
	char *	peer = (char *)SvPV_nolen(ST(1));
	int	retries = (int)SvIV(ST(2));
	int	timeout = (int)SvIV(ST(3));
	char *	sec_name = (char *)SvPV_nolen(ST(4));
	int	sec_level = (int)SvIV(ST(5));
	char *	sec_eng_id = (char *)SvPV_nolen(ST(6));
	char *	context_eng_id = (char *)SvPV_nolen(ST(7));
	char *	context = (char *)SvPV_nolen(ST(8));
	char *	auth_proto = (char *)SvPV_nolen(ST(9));
	char *	auth_pass = (char *)SvPV_nolen(ST(10));
	char *	priv_proto = (char *)SvPV_nolen(ST(11));
	char *	priv_pass = (char *)SvPV_nolen(ST(12));
	int	eng_boots = (int)SvIV(ST(13));
	int	eng_time = (int)SvIV(ST(14));
	char *	auth_master_key = (char *)SvPV_nolen(ST(15));
	size_t	auth_master_key_len = (size_t)SvUV(ST(16));
	char *	priv_master_key = (char *)SvPV_nolen(ST(17));
	size_t	priv_master_key_len = (size_t)SvUV(ST(18));
	char *	auth_localized_key = (char *)SvPV_nolen(ST(19));
	size_t	auth_localized_key_len = (size_t)SvUV(ST(20));
	char *	priv_localized_key = (char *)SvPV_nolen(ST(21));
	size_t	priv_localized_key_len = (size_t)SvUV(ST(22));
	SnmpSession *	RETVAL;
#line 2753 "SNMP.xs"
	{
	   SnmpSession session = {0};
...
XS(XS_SNMP__update_session); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__update_session)
{
    dXSARGS;
    if (items != 7)
	Perl_croak(aTHX_ "Usage: SNMP::_update_session(sess_ref, version, community, peer, lport, retries, timeout)");
    {
	SV *	sess_ref = ST(0);
	char *	version = (char *)SvPV_nolen(ST(1));
	char *	community = (char *)SvPV_nolen(ST(2));
	char *	peer = (char *)SvPV_nolen(ST(3));
	int	lport = (int)SvIV(ST(4));
	int	retries = (int)SvIV(ST(5));
	int	timeout = (int)SvIV(ST(6));
	SnmpSession *	RETVAL;
#line 2908 "SNMP.xs"
	{
           SV **sess_ptr_sv;
...
XS(XS_SNMP__add_mib_dir); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__add_mib_dir)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: SNMP::_add_mib_dir(mib_dir, force=0)");
    {
	char *	mib_dir = (char *)SvPV_nolen(ST(0));
	int	force;
	int	RETVAL;
	dXSTARG;
...
XS(XS_SNMP__init_mib_internals); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__init_mib_internals)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: SNMP::_init_mib_internals()");
    {
#line 2977 "SNMP.xs"
        {
...
XS(XS_SNMP__read_mib); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__read_mib)
{
    dXSARGS;
    if (items < 1 || items > 2)
	Perl_croak(aTHX_ "Usage: SNMP::_read_mib(mib_file, force=0)");
    {
	char *	mib_file = (char *)SvPV_nolen(ST(0));
	int	force;
	int	RETVAL;
	dXSTARG;
...
XS(XS_SNMP__read_module); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__read_module)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::_read_module(module)");
    {
	char *	module = (char *)SvPV_nolen(ST(0));
	int	RETVAL;
	dXSTARG;
#line 3024 "SNMP.xs"
        {
...
XS(XS_SNMP__set); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__set)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: SNMP::_set(sess_ref, varlist_ref, perl_callback)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	SV *	varlist_ref = ST(1);
	SV *	perl_callback = ST(2);
#line 3049 "SNMP.xs"
	{
           AV *varlist;
           SV **varbind_ref;
...
XS(XS_SNMP__catch); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__catch)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: SNMP::_catch(sess_ref, perl_callback)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	SV *	perl_callback = ST(1);
#line 3204 "SNMP.xs"
	{
	   netsnmp_session *ss;
           SV **sess_ptr_sv;
...
XS(XS_SNMP__get); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__get)
{
    dXSARGS;
    if (items != 4)
	Perl_croak(aTHX_ "Usage: SNMP::_get(sess_ref, retry_nosuch, varlist_ref, perl_callback)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	int	retry_nosuch = (int)SvIV(ST(1));
	SV *	varlist_ref = ST(2);
	SV *	perl_callback = ST(3);
#line 3252 "SNMP.xs"
        {
           AV *varlist;
           SV **varbind_ref;
...
XS(XS_SNMP__getnext); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__getnext)
{
    dXSARGS;
    if (items != 3)
	Perl_croak(aTHX_ "Usage: SNMP::_getnext(sess_ref, varlist_ref, perl_callback)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	SV *	varlist_ref = ST(1);
...
XS(XS_SNMP__getbulk); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__getbulk)
{
    dXSARGS;
    if (items != 5)
	Perl_croak(aTHX_ "Usage: SNMP::_getbulk(sess_ref, nonrepeaters, maxrepetitions, varlist_ref, perl_callback)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	int	nonrepeaters = (int)SvIV(ST(1));
	int	maxrepetitions = (int)SvIV(ST(2));
	SV *	varlist_ref = ST(3);
	SV *	perl_callback = ST(4);
#line 3730 "SNMP.xs"
	{
           AV *varlist;
           SV **varbind_ref;
...
XS(XS_SNMP__bulkwalk); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__bulkwalk)
{
    dXSARGS;
    if (items != 5)
	Perl_croak(aTHX_ "Usage: SNMP::_bulkwalk(sess_ref, nonrepeaters, maxrepetitions, varlist_ref, perl_callback)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	int	nonrepeaters = (int)SvIV(ST(1));
...
XS(XS_SNMP__trapV1); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__trapV1)
{
    dXSARGS;
    if (items != 7)
	Perl_croak(aTHX_ "Usage: SNMP::_trapV1(sess_ref, enterprise, agent, generic, specific, uptime, varlist_ref)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	char *	enterprise = (char *)SvPV_nolen(ST(1));
	char *	agent = (char *)SvPV_nolen(ST(2));
	int	generic = (int)SvIV(ST(3));
	int	specific = (int)SvIV(ST(4));
	long	uptime = (long)SvIV(ST(5));
	SV *	varlist_ref = ST(6);
#line 4277 "SNMP.xs"
	{
           AV *varlist;
...
XS(XS_SNMP__trapV2); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__trapV2)
{
    dXSARGS;
    if (items != 4)
	Perl_croak(aTHX_ "Usage: SNMP::_trapV2(sess_ref, uptime, trap_oid, varlist_ref)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	char *	uptime = (char *)SvPV_nolen(ST(1));
	char *	trap_oid = (char *)SvPV_nolen(ST(2));
	SV *	varlist_ref = ST(3);
#line 4421 "SNMP.xs"
	{
           AV *varlist;
...
XS(XS_SNMP__inform); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__inform)
{
    dXSARGS;
    if (items != 5)
	Perl_croak(aTHX_ "Usage: SNMP::_inform(sess_ref, uptime, trap_oid, varlist_ref, perl_callback)");
    SP -= items;
    {
	SV *	sess_ref = ST(0);
	char *	uptime = (char *)SvPV_nolen(ST(1));
...
XS(XS_SNMP__get_type); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__get_type)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: SNMP::_get_type(tag, best_guess)");
    {
	char *	tag = (char *)SvPV_nolen(ST(0));
	int	best_guess = (int)SvIV(ST(1));
	char *	RETVAL;
	dXSTARG;
#line 4731 "SNMP.xs"
	{
...
XS(XS_SNMP__dump_packet); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__dump_packet)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::_dump_packet(flag)");
    {
...
XS(XS_SNMP__map_enum); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__map_enum)
{
    dXSARGS;
    if (items != 4)
	Perl_croak(aTHX_ "Usage: SNMP::_map_enum(tag, val, iflag, best_guess)");
    {
	char *	tag = (char *)SvPV_nolen(ST(0));
	char *	val = (char *)SvPV_nolen(ST(1));
	int	iflag = (int)SvIV(ST(2));
	int	best_guess = (int)SvIV(ST(3));
	char *	RETVAL;
	dXSTARG;
#line 4760 "SNMP.xs"
	{
...
XS(XS_SNMP__translate_obj); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__translate_obj)
{
    dXSARGS;
    if (items != 6)
	Perl_croak(aTHX_ "Usage: SNMP::_translate_obj(var, mode, use_long, auto_init, best_guess, include_module_name)");
    {
	char *	var = (char *)SvPV_nolen(ST(0));
	int	mode = (int)SvIV(ST(1));
	int	use_long = (int)SvIV(ST(2));
	int	auto_init = (int)SvIV(ST(3));
	int	best_guess = (int)SvIV(ST(4));
	int	include_module_name = (int)SvIV(ST(5));
	char *	RETVAL;
	dXSTARG;
#line 4805 "SNMP.xs"
	{
...
XS(XS_SNMP__set_replace_newer); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__set_replace_newer)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::_set_replace_newer(val)");
    {
...
XS(XS_SNMP__set_save_descriptions); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__set_save_descriptions)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::_set_save_descriptions(val)");
    {
	int	val = (int)SvIV(ST(0));
#line 4896 "SNMP.xs"
	{
...
XS(XS_SNMP__set_debugging); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__set_debugging)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::_set_debugging(val)");
    {
	int	val = (int)SvIV(ST(0));
#line 4904 "SNMP.xs"
	{
...
XS(XS_SNMP__debug_internals); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__debug_internals)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::_debug_internals(val)");
    {
	int	val = (int)SvIV(ST(0));
#line 4912 "SNMP.xs"
	{
...
XS(XS_SNMP__mib_toggle_options); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__mib_toggle_options)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::_mib_toggle_options(options)");
    {
	char *	options = (char *)SvPV_nolen(ST(0));
#line 4925 "SNMP.xs"
	{
...
XS(XS_SNMP__sock_cleanup); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__sock_cleanup)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: SNMP::_sock_cleanup()");
    {
#line 4932 "SNMP.xs"
	{
	   SOCK_CLEANUP;
...
XS(XS_SNMP__mainloop_finish); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__mainloop_finish)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: SNMP::_mainloop_finish()");
    {
#line 4939 "SNMP.xs"
	{
	    mainloop_finish = 1;
...
XS(XS_SNMP__main_loop); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__main_loop)
{
    dXSARGS;
    if (items < 3 || items > 4)
	Perl_croak(aTHX_ "Usage: SNMP::_main_loop(timeout_sec, timeout_usec, perl_callback, ss=(SnmpSession*)NULL)");
    {
	int	timeout_sec = (int)SvIV(ST(0));
	int	timeout_usec = (int)SvIV(ST(1));
	SV *	perl_callback = ST(2);
	SnmpSession *	ss;
	...
	if (items < 4)
	    ...
	    if (sv_derived_from(ST(3), "SnmpSessionPtr")) {
		IV tmp = SvIV((SV*)SvRV(ST(3)));
		ss = INT2PTR(SnmpSession *,tmp);
	    }
	    else
		Perl_croak(aTHX_ "ss is not of type SnmpSessionPtr");
	}
#line 4957 "SNMP.xs"
	{
        int numfds, fd_count;
...
XS(XS_SNMP__get_select_info); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__get_select_info)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: SNMP::_get_select_info()");
...
XS(XS_SNMP__read_on_fd); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__read_on_fd)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SNMP::_read_on_fd(fd)");
    {
...
XS(XS_SNMP__check_timeout); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__check_timeout)
{
    dXSARGS;
    if (items != 0)
	Perl_croak(aTHX_ "Usage: SNMP::_check_timeout()");
    {
#line 5106 "SNMP.xs"
	{
          snmp_timeout();
...
XS(XS_SNMP__MIB__NODE_TIEHASH); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__MIB__NODE_TIEHASH)
{
    dXSARGS;
    if (items < 2 || items > 3)
	Perl_croak(aTHX_ "Usage: SNMP::MIB::NODE::TIEHASH(cl, key, tp=0)");
    {
	char *	cl = (char *)SvPV_nolen(ST(0));
...
XS(XS_SNMP__MIB__NODE_FETCH); /* prototype to pass -Wmissing-prototypes */
XS(XS_SNMP__MIB__NODE_FETCH)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: SNMP::MIB::NODE::FETCH(tp_ref, key)");
    {
	SV *	tp_ref = ST(0);
	char *	key = (char *)SvPV_nolen(ST(1));
	SV *	RETVAL;
...
XS(XS_SnmpSessionPtr_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_SnmpSessionPtr_DESTROY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: SnmpSessionPtr::DESTROY(sess_ptr)");
    {
	...
	if (SvROK(ST(0))) {
	    ...
	    Perl_croak(aTHX_ "sess_ptr is not a reference");
#line 5438 "SNMP.xs"
	{
	if(sess_ptr != NULL)
	{
...
extern "C"
#endif
XS(boot_SNMP); /* prototype to pass -Wmissing-prototypes */
XS(boot_SNMP)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXS("SNMP::constant", XS_SNMP_constant, file);
        newXS("SNMP::_sys_uptime", XS_SNMP__sys_uptime, file);
        newXS("SNMP::init_snmp", XS_SNMP_init_snmp, file);
        newXS("SNMP::_api_mode", XS_SNMP__api_mode, file);
        newXS("SNMP::_new_session", XS_SNMP__new_session, file);
        newXS("SNMP::_new_v3_session", XS_SNMP__new_v3_session, file);
        newXS("SNMP::_update_session", XS_SNMP__update_session, file);
        newXS("SNMP::_add_mib_dir", XS_SNMP__add_mib_dir, file);
        newXS("SNMP::_init_mib_internals", XS_SNMP__init_mib_internals, file);
        newXS("SNMP::_read_mib", XS_SNMP__read_mib, file);
        newXS("SNMP::_read_module", XS_SNMP__read_module, file);
        newXS("SNMP::_set", XS_SNMP__set, file);
        newXS("SNMP::_catch", XS_SNMP__catch, file);
        newXS("SNMP::_get", XS_SNMP__get, file);
        newXS("SNMP::_getnext", XS_SNMP__getnext, file);
        newXS("SNMP::_getbulk", XS_SNMP__getbulk, file);
        newXS("SNMP::_bulkwalk", XS_SNMP__bulkwalk, file);
        newXS("SNMP::_trapV1", XS_SNMP__trapV1, file);
        newXS("SNMP::_trapV2", XS_SNMP__trapV2, file);
        newXS("SNMP::_inform", XS_SNMP__inform, file);
        newXS("SNMP::_get_type", XS_SNMP__get_type, file);
        newXS("SNMP::_dump_packet", XS_SNMP__dump_packet, file);
        newXS("SNMP::_map_enum", XS_SNMP__map_enum, file);
        newXS("SNMP::_translate_obj", XS_SNMP__translate_obj, file);
        newXS("SNMP::_set_replace_newer", XS_SNMP__set_replace_newer, file);
        newXS("SNMP::_set_save_descriptions", XS_SNMP__set_save_descriptions, file);
        newXS("SNMP::_set_debugging", XS_SNMP__set_debugging, file);
        newXS("SNMP::_debug_internals", XS_SNMP__debug_internals, file);
        newXS("SNMP::_mib_toggle_options", XS_SNMP__mib_toggle_options, file);
        newXS("SNMP::_sock_cleanup", XS_SNMP__sock_cleanup, file);
        newXS("SNMP::_mainloop_finish", XS_SNMP__mainloop_finish, file);
        newXS("SNMP::_main_loop", XS_SNMP__main_loop, file);
        newXS("SNMP::_get_select_info", XS_SNMP__get_select_info, file);
        newXS("SNMP::_read_on_fd", XS_SNMP__read_on_fd, file);
        newXS("SNMP::_check_timeout", XS_SNMP__check_timeout, file);
        newXS("SNMP::MIB::NODE::TIEHASH", XS_SNMP__MIB__NODE_TIEHASH, file);
        newXS("SNMP::MIB::NODE::FETCH", XS_SNMP__MIB__NODE_FETCH, file);
        newXS("SnmpSessionPtr::DESTROY", XS_SnmpSessionPtr_DESTROY, file);
    XSRETURN_YES;
}

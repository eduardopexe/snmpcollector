...
#line 260 "TrapReceiver.xs"
	oid myoid[MAX_OID_LEN];
	size_t myoid_len = MAX_OID_LEN;
        trapd_cb_data *cb_data;
        int gotit=1;
        netsnmp_trapd_handler *handler = NULL;
#line 384 "TrapReceiver.c"
	int	RETVAL;
	dXSTARG;
#line 266 "TrapReceiver.xs"
        {

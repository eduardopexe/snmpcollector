...
XS(XS_NetSNMP__agent__netsnmp_handler_registration_DESTROY); /* prototype to pass -Wmissing-prototypes */
XS(XS_NetSNMP__agent__netsnmp_handler_registration_DESTROY)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: NetSNMP::agent::netsnmp_handler_registration::DESTROY(reginfo)");
    {
	netsnmp_handler_registration *	reginfo;
...
XS(XS_NetSNMP__agent__netsnmp_handler_registration_register); /* prototype to pass -Wmissing-prototypes */
XS(XS_NetSNMP__agent__netsnmp_handler_registration_register)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: NetSNMP::agent::netsnmp_handler_registration::register(me)");
    {
	SV *	me = ST(0);
#line 545 "agent.xs"
        netsnmp_handler_registration *reginfo;
...
XS(XS_NetSNMP__agent__netsnmp_handler_registrationPtr_getRootOID); /* prototype to pass -Wmissing-prototypes */
XS(XS_NetSNMP__agent__netsnmp_handler_registrationPtr_getRootOID)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: NetSNMP::agent::netsnmp_handler_registrationPtr::getRootOID(me)");
    SP -= items;
    {
	SV *	me = ST(0);
#line 565 "agent.xs"
...
XS(XS_NetSNMP__agent__netsnmp_agent_request_info_getSourceIp); /* prototype to pass -Wmissing-prototypes */
XS(XS_NetSNMP__agent__netsnmp_agent_request_info_getSourceIp)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: NetSNMP::agent::netsnmp_agent_request_info::getSourceIp(me)");
    {
	SV *	me = ST(0);
#line 1077 "agent.xs"
        netsnmp_agent_request_info *reqinfo;
...
XS(XS_NetSNMP__agent__netsnmp_agent_request_info_getDestIp); /* prototype to pass -Wmissing-prototypes */
XS(XS_NetSNMP__agent__netsnmp_agent_request_info_getDestIp)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: NetSNMP::agent::netsnmp_agent_request_info::getDestIp(me)");
    {
	SV *	me = ST(0);
#line 1098 "agent.xs"
        netsnmp_agent_request_info *reqinfo;
...
XS(boot_NetSNMP__agent)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("NetSNMP::agent::netsnmp_handler_registration::DESTROY", XS_NetSNMP__agent__netsnmp_handler_registration_DESTROY, file, "$");
        newXSproto("NetSNMP::agent::netsnmp_handler_registration::register", XS_NetSNMP__agent__netsnmp_handler_registration_register, file, "$");
        newXSproto("NetSNMP::agent::netsnmp_handler_registrationPtr::getRootOID", XS_NetSNMP__agent__netsnmp_handler_registrationPtr_getRootOID, file, "$");
        ...
        newXSproto("NetSNMP::agent::netsnmp_agent_request_info::getSourceIp", XS_NetSNMP__agent__netsnmp_agent_request_info_getSourceIp, file, "$");
        newXSproto("NetSNMP::agent::netsnmp_agent_request_info::getDestIp", XS_NetSNMP__agent__netsnmp_agent_request_info_getDestIp, file, "$");
